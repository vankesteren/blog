...
See? The maximum diagnosticity of a _p_-value of 0.05 is just under 2.5. That means that if you obtain this _p_-value, the optimal alternative hypothesis is less than 2.5 more likely than the null hypothesis. 
...
## 8
I agree! In general, _p_-values down to about 0.01 are never much more likely to occur under $H_0$ relative to $H_1$, even when we cheat to favout $H_1$. What MPR value is enough for you to believe the result is for you to decide. Some choose to interpret this ratio as an upper bound to the _Bayes Factor_, but that's for another time...
