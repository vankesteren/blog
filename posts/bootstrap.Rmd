...
```{r prec, tidy=TRUE, fig.align="center"}
...
# text
text(y = c(1,2,3), x = 172, labels = c("N = 1000", "N = 100", "N = 20"), pos = 4, cex = 1.3)
```
...
```{r boot, tidy=TRUE, fig.align="center"}
...
```{r bootCI, tidy=TRUE, fig.align="center"}
...
# text
text(y = c(1,2), x = 172, labels = c("Bootstrap CI", "Theoretical CI"), pos = 4, cex = 1.3)

# points
points(c(meanm, meanm), c(2,1), bg = c("black", "dark green"), 
       col = c("black", "dark green"), pch=24)
...
```{r bootCI2, tidy=TRUE, fig.align="center"}
...
```{r FifthPerc, tidy=TRUE, fig.align="center"}
