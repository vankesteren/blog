---
title: "Multiple regression via coordinate descent"
...
# control variables
convergence <- FALSE 
tol <- .Machine$double.eps # tolerance or precision
max.iter <- 1000
i <- 0
...
while (!convergence && i < max.iter) {
  ...
  dif <- abs(bprev - bhat)
  if (all(dif < tol)) convergence <- TRUE
}
```
