...
```{r differential, fig.align='center'}
par(family="serif")
# Large DE
...
```{r separation, tidy=TRUE, dpi = 400, dev='png'}
par(family="serif")
...
```{r whitening, fig.align="center", fig.width=12, message=FALSE, dev="png", dpi=400}
...
```{r whitening2class, fig.align="center", fig.width=12, message=FALSE, dev="png", dpi=400, fig.height=12}
